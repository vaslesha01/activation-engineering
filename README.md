...
Эксперимент: Управление моделью **Idefics2-8b** с помощью вектора концепта «Взрыв», извлеченного из датасета изображений взрывов.
...
Эксперимент: Управление моделью **LLaMA-3-8B** с использованием векторов поведения.
